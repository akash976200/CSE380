...
can_free_prisoner <- function(knight_is_awake,
                              ...
                              prisoner_is_awake,
                              pet_dog_is_present) {
  (!archer_is_awake && pet_dog_is_present)||((!archer_is_awake && !knight_is_awake)&& prisoner_is_awake)
 # ((!archer_is_awake && pet_dog_is_present) || (knight_is_awake || prisoner_is_awake))||((!archer_is_awake && !knight_is_awake && prisoner_is_awake) || pet_dog_is_present)

#(!archer_is_awake) && (prisoner_is_awake ||( (!knight_is_awake) && pet_dog_is_present ))
